...
/* 0x00 响应：参考旧项目 GetGatewayBasicInformation
 * 实际发送长度 = step00_table(35) + 4 = 39 字节
 */
static const uint8_t ble1to1_basic_info[] = {
    0x00, 0x22, 0x00, 0x2d, 0x01, 0xa5, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x20, 0x00,
    0x10, 0x00, 0x00, 0x00,
    0xee, 0xdc, 0x92, 0xc9, 0x09, 0x42, 0xa1, 0x54,
    0xee, 0x75, 0xcc, 0xdb, 0xa7, 0x8a, 0x05, 0x70,
    0x00, 0x00, 0x00, 0x00
};
